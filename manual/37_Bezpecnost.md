# 37. Bezpečnost (2FA, IP allowlist, role, activity log)
...
## 37.2 Dvoufaktorové ověření (TOTP)
...
> viz [§ 37.2.3](#3723-ztrata-telefonu-deaktivace).

### 37.2.2 Přihlášení s 2FA
...
### 37.2.3 Ztráta telefonu / deaktivace
...
### 37.2.4 Vynucení 2FA pro všechny uživatele
...
### 37.2.5 E-mailové ověření (pro uživatele bez authenticator app)
...
### 37.4.1 Za reverse proxy: `trusted_proxies` (důležité)
...
Viz [34. Nastavení](34_Nastaveni.md) pro UI.

### 37.7.1 Co log NEUKLÁDÁ
...
### 37.7.2 Jak se do logu zapisuje IP adresa
...
§ 37.4.1). Z hlavičky se bere **první** adresa (původní klient). Bez nastavené
