...
## 38.1 Co všechno se aktualizuje
...
## 38.2 Daily check — jak to funguje
...
## 38.3 Footer aplikace + badge nové verze
...
## 38.5 Migrace na single-volume layout (3.5.x → 3.6.0)
...
## 38.8 Dohled na nové verze bez UI
