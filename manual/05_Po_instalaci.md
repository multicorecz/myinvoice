...
- **Dodavatel** — IČO/DIČ, adresa, logo, číslování faktur, bankovní účty
  (Nastavení → Můj dodavatel; detail viz [Nastavení](34_Nastaveni.md)).
...
- **Daňové nastavení** — typ poplatníka, perioda DPH, kód FÚ (pokud jsi plátce;
  viz [Výkazy DPH](27_Vykazy_DPH.md)).
- **Zabezpečení** — 2FA, IP allowlist, role uživatelů (viz [Bezpečnost](37_Bezpecnost.md)).
...
- Pinuj konkrétní verzi image a sleduj [Aktualizace](38_Aktualizace.md).
